...
In addition to the regular workshop, we will also host a data challenge track with two shared tasks for fake review detection in an adversarial framework and fake news detection (details will be announced later).
...
We also invite participants for TrueFact 2020 Shared Tasks. Instructions for participation and awards will be announced later.
...
Workshop paper notifications: June 15, 2019
